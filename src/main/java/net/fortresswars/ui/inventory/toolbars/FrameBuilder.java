...
public interface FrameBuilder {
    /**
     * Specifies the frame button builder for an {@link Menu}. This can be customized to render different frame
     * buttons for a GUI.
     *
     ...
     * @param menu The inventory the frame is being rendered in.
     * @return The button to be rendered for that slot, or null if no button should be rendered.
     */
    @Nullable
    Button buildFrameButton(int slot, int page, @NotNull FrameButtonType defaultType, @NotNull Menu menu);
}
